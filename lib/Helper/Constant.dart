...
const String appName = 'Flash Electronics';

//please add your panel's API base URL here (you can find from settings->client APIs)
const String baseUrl = 'https://flashelectronics.online/app/v1/api/';
const String chatBaseUrl = 'https://flashelectronics.online/app/v1/Chat_Api/';

//for codecanyon demo app only, don't change it
const bool isDemoApp = false;

//Your package name
const String packageName = 'com.flash.electronics';
